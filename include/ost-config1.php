...
define('SECRET_SALT','Yd78O0Q=o75C92ZvqMbRa7uzhoXryY0q');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','budi.ramadhanus@meikarta.com');
...
define('DBNAME','melitaDB');
define('DBUSER','development');
define('DBPASS','M31k4rt4');

# Table prefix
define('TABLE_PREFIX','mlt_');
